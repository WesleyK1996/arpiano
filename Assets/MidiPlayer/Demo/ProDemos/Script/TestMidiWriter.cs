...
namespace MidiPlayerTK
{
    ...
    public class TestMidiWriter : MonoBehaviour
    {
        ...
        /// </summary>
        private long CurrentTimeMs { get { return Convert.ToInt64( Time.realtimeSinceStartup * 1000); } }


        bool SequenceIsPlaying = false;
        SequencerTrack PianoTrack;
        long TimeStartCreateSequence;
        long TimeStartPlay;
        ...
        void Awake()
        {
            ...
            for (int key = 0; key < KeysState.Length; key++)
                KeysState[key] = new KeyboardState() { Key = key, Note = null, TimeNoteOn = 0 };
        }
        ...
        {
            TimeStartPlay = CurrentTimeMs - 100; // Let 100ms before playing
