    ...
    public class MidiListPlayerEditor : Editor
    {
        ...
        void OnEnable()
        {
            try
            {
                ...
                if (winSelectMidi != null)
                {
                    ...
                    winSelectMidi.SelectedItem = indexMidiSelected;
        ...
        public override void OnInspectorGUI()
        {
            ...
            try
            {
                ...
                commonEditor.DrawCaption("Midi List Player - Play Midi from a list of Midi ", "https://paxstellar.fr/midi-list-player-v2/");
                ...
                if (instance.MPTK_PlayList != null)
                    for (int i = 0; i < instance.MPTK_PlayList.Count; i++)
                    {
                        ...
                        if (GUILayout.Button(playing.MidiName, myStyle.BtTransparent, GUILayout.Width(250), GUILayout.Height(hCell)))//, GUILayout.Height(20f)))
                        {
                            ...
                            //Debug.Log("Midi selected " + indexEditItem + " " + playing.MidiName + " " + indexMidiSelected);
                        }
                ...
                if (indexEditItem >= 0 && indexEditItem < instance.MPTK_PlayList.Count)
                {
                    ...
                    if (indexlabFormatMidiTime == 0 || indexlabFormatMidiTime == 1)
                    {
                        float currentPosition = itemSelected.StartFrom;
                        float newPosition = (float)Math.Round(
                            EditorGUILayout.Slider(
                                new GUIContent(" ", tooltip),
                                currentPosition, 0f,
                                itemSelected.RealDurationMs));
                    ...
                    {
                        // midi ticks position
                        itemSelected.StartFrom =
                           (float)(EditorGUILayout.IntSlider(new GUIContent(" ", tooltip),
                            (int)(itemSelected.StartFrom * itemSelected.TickLengthMs), 0,
                    ...
                    {
                        // midi ticks position
                        itemSelected.EndFrom =
                            (float)(EditorGUILayout.IntSlider(new GUIContent(" ", tooltip),
                            (int)(itemSelected.EndFrom * itemSelected.TickLengthMs), 0,
                            (int)(itemSelected.RealDurationMs * itemSelected.TickLengthMs)) / itemSelected.TickLengthMs);
                    }
                    EditorGUILayout.EndVertical();
                    ...
                    if (indexlabFormatMidiTime == 0 || indexlabFormatMidiTime == 1)
                    {
                        ...
                        float newPosition = (float)Math.Round(
                            EditorGUILayout.Slider(new GUIContent(" ", tooltip), currentPosition, 0f, currentDuration));
        ...
        private string FormatingDuration(double tsDuration, double tickLengthMs)
        {
            ...
            else if (indexlabFormatMidiTime == 1)
        ...
        private void GlobalProperties()
        {
            ...
            indexlabFormatMidiTime = EditorGUILayout.Popup("Duration Format", indexlabFormatMidiTime, optionsFormatDuration);
        ...
        private void ActionButtons()
        {
            ...
            if (GUILayout.Button(new GUIContent(buttonIconAdd, "Add a Midi to the playing list"), EditorStyles.miniButtonRight, miniButtonWidth, GUILayout.Height(20f)))
            {
            ...
            // remove selected midi from the list
