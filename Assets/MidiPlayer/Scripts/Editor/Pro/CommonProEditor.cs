...
namespace MidiPlayerTK
{
    ...
    public class CommonProEditor : ScriptableObject
    {
        public static void EffectSoundFontParameters(MidiSynth instance, CustomStyle myStyle)
        {
            ...
            EditorGUILayout.LabelField("These effects will be applied independently on each voices. Effects values are defined in the SoundFont, so limited modification can't be applied.", myStyle.LabelGreen);
